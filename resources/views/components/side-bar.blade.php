    ...
    <div class="collapse navbar-collapse  w-auto py-2" id="sidenav-collapse-main" style="height: auto !important">
        <ul class="navbar-nav">
            @if (auth()->user()->level === 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Mahasiswa' ? 'active' : '' }} " href="/manage-mahasiswa">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Dosen' ? 'active' : '' }} " href="/manage-dosen">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-people-fill" viewBox="0 0 16 16">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Pembimbing Industri' ? 'active' : '' }} "
                        href="/manage-pembimbing-industri">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Perusahaan' ? 'active' : '' }} " href="/manage-perusahaan">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Mata Kuliah' ? 'active' : '' }} " href="/manage-matakuliah">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Aspek Penilaian' ? 'active' : '' }} " href="/aspek-penilaian">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'Magang' ? 'active' : '' }} " href="/manage-magang">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            @if (auth()->user()->level === 'pembimbing')
                ...
                @endif @if (auth()->user()->level === 'pembimbing industri')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $title === 'Penilaian' ? 'active' : '' }} " href="/penilaian-industri">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
